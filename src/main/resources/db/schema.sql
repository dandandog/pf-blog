...
(
    ...
    INDEX `uk_parent_id` (`parent_id`) USING BTREE
) ENGINE = InnoDB
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '角色资源关系'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `role_id`   varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '角色uuid',
    `role_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '角色唯一标识',
    PRIMARY KEY (`id`) USING BTREE,
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '内容配置'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '内容'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '元数据'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '元数据关联内容 '
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '个人信息'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for dict_node
-- ----------------------------
DROP TABLE IF EXISTS `dict_node`;
CREATE TABLE `dict_node`
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '字典节点'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `code`          varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字典标识',
    `seq`           int(11) UNSIGNED                                              NULL DEFAULT NULL COMMENT '排序',
    `req`           char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci      NULL DEFAULT NULL COMMENT '是否默认值',
    `remark`        varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '过滤',
    `type`          int(1)                                                        NULL DEFAULT NULL COMMENT '输入类型（1：文本；2：下拉；......）',
    ...
    CONSTRAINT `fk_set_dict_value_set_dict_node_1` FOREIGN KEY (`node_id`) REFERENCES `dict_node` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '字典值'
  ROW_FORMAT = Dynamic;
